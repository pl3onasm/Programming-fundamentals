  ...
  ensures x + y + z == a + b + c
{
  ...
  /* 
    ...
    So what we actually want is to sort the triple (a, b, c) 
    ...
    shift 1 unit of 'mass' from the larger number to the smaller
    number, thereby reducing the drop by 1.
  ...
  */
  ...
  /* Loop exit:
     ...
     which is equivalent to:  x <= y  and  y <= z
