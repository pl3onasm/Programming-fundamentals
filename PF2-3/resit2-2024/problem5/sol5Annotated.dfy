...
{
    // Returns the value of the recursive function f at x
  if x <= 2 then 1
  ...
  ensures x == f(n)
{
  ...
  /* 
    ...
    recursively with a base case and three recursive cases,
    depending on n % 3:
    ...
    Thus, for n > 2, each evaluation of f(n) involves a single 
    recursive call to f with argument n/3 or n/3 + 1.
