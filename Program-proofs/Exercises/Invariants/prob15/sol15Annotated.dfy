...
reads a
{
    // We define U(a, k) = ∑(a[i] | 0 ≤ i < k)
    // Base case: U(a, 0) = ∑(a[i] | 0 ≤ i < 0) 
    //                    = ∑(∅) = 0
    // For k > 0:
    // U(a, k)
    //   = ∑(a[i] | 0 ≤ i < k)
